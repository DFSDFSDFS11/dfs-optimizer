...
async function main() {
  console.log('=== Argus-v6 (GBM v2 field model: 11 features, depth 6) LOO validation, 16 dev slates ===\n');
  ...
  console.log('\n================================================================');
  console.log('AGGREGATE — Argus-v4 (pool) vs Argus-v6 (GBM v2: 11 features, depth 6)');
  console.log('================================================================');
  ...
  fs.writeFileSync(path.join(OUT_DIR, 'argus_v6_all_slates_loo.csv'), csvLines.join('\n'));
  console.log(`\nSaved per-slate results to ${path.join(OUT_DIR, 'argus_v6_all_slates_loo.csv')}`);
}
